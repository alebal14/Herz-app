...
function enableMic(status){
    if (status === 0){
        document.getElementById('startRecID').src = "http://ideweb2.hh.se/~sigsto14/Test/img/mick.png";
        document.getElementById('startRecID').className = " ";
    }
    else if (status == 1){
        document.getElementById('startRecID').src = "http://ideweb2.hh.se/~sigsto14/Test/img/mickactive.png";
...
function recordNow() {
    ...
    // Stop recording after 10 000 sec
